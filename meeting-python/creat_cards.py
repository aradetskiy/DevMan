...
def make_skills():
    file = open(path.join('meeting-python', 'src',
                'skills.txt'), 'r', 'utf-8',)
...
def make_card_npc():
    ...
    render_template(path.join('meeting-python', 'src', 'charsheet.svg'), path.join('meeting-python',
                    'Repl', f'{context["first_name"]}_{context["last_name"]}_charsheet.svg'), context)
